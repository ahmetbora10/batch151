...
public class C08_IfElse {
    ...
    */
        ...
        System.out.println("Lutfen hizmet Yilini giriniz");
        ...
        if(HizmetYili>=5 ){
            System.out.println("Zamli maasiniz : " + (Maas+0.1*Maas));;

        }else{
            System.out.println("Zam Alabilmek icin " + "Yil Daha Calismalisin");
        }
