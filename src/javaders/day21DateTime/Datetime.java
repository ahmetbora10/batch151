...
public class Datetime {
    public static void main(String[] args) {
        ...
        //Tokya'da ayin kaci?
        ProxySelector ZoneId;
        LocalDate  dateInTokyo = LocalDate.now(java.time.ZoneId.of("Asia/Tokyo"));
        System.out.println(dateInTokyo);//2023-03-17

        //Tashkent'te ayin kaci?
        LocalDate  dateInTashkent = LocalDate.now(java.time.ZoneId.of("Asia/Tashkent"));
        System.out.println(dateInTashkent);// 2023-03-16

        //Tokyo'da saat kac?
        LocalTime timeInTokyo = LocalTime.now(java.time.ZoneId.of("Asia/Tokyo"));
        System.out.println(timeInTokyo);// 03:50:06.866277

        //Koln'de saat kac?
        LocalTime timeInBerlin = LocalTime.now(java.time.ZoneId.of("Europe/Berlin"));
