...
public class IllegalGradeException extends  Exception {
    /*
    1-)Custom Exception Class olusturmak icin Excetion Class``a exdend etmeliyiz.
    Exception Classà extend olusturdugunuz Custom Exception"Compile Time Exception"olur.
  ...
  3)Custon Exception Callas olusturdugunuzda ismin sonunda Exception kelimeini kullanmalisiniz,
